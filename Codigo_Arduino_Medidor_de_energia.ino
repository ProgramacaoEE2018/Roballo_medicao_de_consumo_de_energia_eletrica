...
class Dados
{
  public:
    ...
    void tensao(unsigned int _inPinV, double _VCAL, double _PHASECAL);
    void corrente(unsigned int _inPinI, double _ICAL);

    void tensaoTX(double _VCAL, double _PHASECAL);
    void correnteTX(unsigned int _channel, double _ICAL);
...
void Dados::tensao(unsigned int _inPinV, double _VCAL, double _PHASECAL)
{
  inPinV = _inPinV;
  VCAL = _VCAL;
  PHASECAL = _PHASECAL;
...
void Dados::corrente(unsigned int _inPinI, double _ICAL)
{
  inPinI = _inPinI;
  ICAL = _ICAL;
...
//--------------------------------------------------------------------------------------
void Dados::tensaoTX(double _VCAL, double _PHASECAL)
{
  inPinV = 2;
  VCAL = _VCAL;
  PHASECAL = _PHASECAL;
...
void Dados::correnteTX(unsigned int _channel, double _ICAL)
{
...
void setup()
{
  ...
  emon1.corrente(pino_sct, 29);
  emon1.tensao(2, 234.26, 1.7);
}
